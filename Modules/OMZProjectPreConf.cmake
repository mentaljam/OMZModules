...
#### Version definitions
add_definitions(-DVERSION_${PROJECT_NAME_UPPER}_MAJOR=${${PROJECT_NAME_UPPER}_VERSION_MAJOR}
                -DVERSION_${PROJECT_NAME_UPPER}_MINOR=${${PROJECT_NAME_UPPER}_VERSION_MINOR}
                -DVERSION_${PROJECT_NAME_UPPER}_STRING="${${PROJECT_NAME_UPPER}_VERSION_STRING}"
                -DVERSION_${PROJECT_NAME_UPPER}_DATE="${${PROJECT_NAME_UPPER}_VERSION_DATE}"
                -DVERSION_${PROJECT_NAME_UPPER}_OS="${CMAKE_SYSTEM_NAME}"
                -DVERSION_${PROJECT_NAME_UPPER}_ARCH="${COMPILED_ARCH}"
)
