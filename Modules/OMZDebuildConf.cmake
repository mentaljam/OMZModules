...
if(DEBUILD_EXECUTABLE)
    ...
    file(APPEND ${TARGET_FILE}
            ...
            "set(DEBIAN_SOURCE_ORIG_PATH \${CMAKE_CURRENT_LIST_DIR}/Debian/${CMAKE_PROJECT_NAME}_${${PROJECT_NAME_UPPER}_VERSION_STRING})\n"
    ...
    file(APPEND ${TARGET_FILE}
            ...
            "    set(RELEASE_PACKAGE_VERSION ${${PROJECT_NAME_UPPER}_VERSION_STRING}\${RELEASE_PACKAGE_VERSION})\n"
...
#            "           \"Standards-Version: 3.8.4\\n\"\n"
    ...
    file(APPEND ${TARGET_FILE}
            ...
            "            \"\tcd $(BUILDDIR); cmake \${CMAKE_ARGUMENTS} "
                              ...
                              "-D${PROJECT_NAME_UPPER}_VERSION_MAJOR=\\\"\${${PROJECT_NAME_UPPER}_MAJOR}\\\" "
